...
const StaffCard = ({ staff }: { staff: StaffMember }) => {
    ...
    return (
        <Card className="testimonial-card overflow-hidden text-center group h-full flex flex-col hover:-translate-y-2">
            ...
            <CardContent className="flex flex-grow flex-col p-6 space-y-3">
                ...
                <div className="flex items-center justify-center gap-4 pt-4 border-t border-neutral-border">
                 ...
                 <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                        {departments.map((dept, index) => (
                            <Card key={index} className="testimonial-card text-center p-8 group relative overflow-hidden hover:-translate-y-2">
                ...
                <section className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12">
                        {teamQualities.map((quality, index) => (
                            <div key={index} className="flex items-start gap-4 rounded-lg bg-neutral-surface p-4 border border-transparent hover:border-primary/20 transition-colors">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                        {staffAchievements.map((ach, index) => (
                             <Card key={index} className="testimonial-card p-6 text-center group relative overflow-hidden hover:-translate-y-2">
